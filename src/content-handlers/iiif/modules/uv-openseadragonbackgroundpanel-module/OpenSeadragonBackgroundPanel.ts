...
export class OpenSeadragonBackgroundPanel extends BaseView<
  //todo: split out OpenSeadragonBackgroundPanel in module config
...
> {
  ...
  create(): void {
    ...
    this.$element.on("mousemove", (e: JQuery.MouseMoveEvent) => {
      ...
      const centerPanel = (this.extension as OpenSeadragonExtension)
        .centerPanel;
      centerPanel?.$element.trigger("mousemove");
    });
  }
  ...
  async createUI(): Promise<void> {
    ...
    this.viewer = OpenSeadragon({
      ...
      // to do, get this working in panel refactor
